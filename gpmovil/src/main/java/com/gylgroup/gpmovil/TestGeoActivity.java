...
import com.gylgroup.gpmovil.FetchAddressIntentService;
 ...
 */
public class TestGeoActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFetchLocationButton = (Button) findViewById(R.id.fetch_location_button);
    ...
    @SuppressWarnings("unused")
    public void fetchLocationButtonHandler(View view) {
    ...
    private void startLocationIntentService() {
        ...
        // Pass the location data as an extra to the service.
        intent.putExtra(Constants.ADDRESS_DATA_EXTRA, "Acoyte 944, CABA");
            ...
            showSnackbar(R.string.permission_rationale, android.R.string.ok,
                    new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            // Request permission
                            ActivityCompat.requestPermissions(TestGeoActivity.this,
